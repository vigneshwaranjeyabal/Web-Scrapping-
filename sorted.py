...
def scrape_posts(max_posts=100):
    ...
    while posts_scraped < max_posts and scroll_attempts < 110:
        ...
        for post in post_containers[posts_scraped:]:
            ...
            try:
                ...
                #profile_link = post.find_element(By.XPATH, ".//a[contains(@class, 'update-components-actor__meta-link')]").get_attribute("href")
                #profile_link = post.find_element(By.XPATH, ".//a[@href]").get_attribute("href")
...
all_post_data = scrape_posts(max_posts=100)
...
sorted_post_df.to_excel("sorted.xlsx", index=False)
